            ...
            <div className="mx-auto max-w-2xl space-y-6">
                ...
                <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                    ...
                    >
                        ...
                        {/* Info akun auto-generate (revisi baru) */}
                        <p className="rounded-xl border border-[#cddcef] bg-[#e8f2fe]/50 px-4 py-3 text-xs leading-relaxed text-[#0b4fb0]">
                            Saat OPD disimpan, sistem otomatis membuat akun
                            admin OPD (username + password acak). Kredensial
                            akan ditampilkan sekali — salin dan bagikan ke OPD
                            terkait. OPD baru yang aktif langsung tampil di
                            daftar OPD halaman utama.
                        </p>
                    </form>
                </div>
            </div>
