            ...
            <AnimatePresence mode="wait">
                {mode === 'approve' ? (
                    ...
                    >
                        ...
                        {/* Info No. SK — dibuat otomatis & statis saat disetujui */}
                        <div className="flex gap-2.5 rounded-xl border border-[#cddcef] bg-[#e8f2fe]/50 px-4 py-3">
                            <FileBadge2 className="mt-0.5 size-4 shrink-0 text-[#106feb]" />
                            <p className="text-xs leading-relaxed text-[#0b4fb0]">
                                Saat disetujui, sistem langsung menerbitkan{' '}
                                <span className="font-semibold">Nomor SK</span>{' '}
                                (auto-increment) dan{' '}
                                <span className="font-semibold">
                                    Tanggal Terbit
                                </span>{' '}
                                surat penerimaan. Nomor & tanggal bersifat tetap
                                — cetak ulang tidak mengubahnya.
                            </p>
                        </div>
